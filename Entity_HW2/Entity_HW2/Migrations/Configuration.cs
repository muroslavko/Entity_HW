...
namespace Entity_HW2.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Entity_HW2.AcademyDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "Entity_HW2.AcademyDbContext";
        }

        protected override void Seed(Entity_HW2.AcademyDbContext context)
        {
